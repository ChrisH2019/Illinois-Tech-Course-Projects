...
(function ($) { 
	...
	if ($('input[id^="' + cmsms_settings.shortname + '_logo_type"]:checked').val() === 'image') {
		...
		$('#' + cmsms_settings.shortname + '_logo_resp_url').parents('tr').hide();
		$('#' + cmsms_settings.shortname + '_logo_resp_url_retina').parents('tr').hide();
	...
	$('input[id^="' + cmsms_settings.shortname + '_logo_type"]').bind('change', function () { 
		if ($(this).is(':checked') && $(this).val() === 'image') {
			...
			$('#' + cmsms_settings.shortname + '_logo_resp_url').parents('tr').show();
			$('#' + cmsms_settings.shortname + '_logo_resp_url_retina').parents('tr').show();
